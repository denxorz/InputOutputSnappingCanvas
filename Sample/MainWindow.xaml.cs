...
public partial class MainWindow
{
    ...
    public ObservableCollection<UserControl> Items { get; } =
    [
    ...
    public ObservableCollectionWithAddRange<TreeViewItem> Groups { get; } = [];
    public ObservableCollectionWithAddRange<string> Groups2 { get; } = [];
